  ...
  integrations: [
    ...
    htaccessIntegration({
      ...
      redirects: [
        ...
        { match: "^\\/information", url: "/about", code: 301 },
        { match: "^\\/Entrar", url: "/", code: 301 },
        { match: "^\\/jcomments$", url: "/contact", code: 301 },
        { match: "^\\/boletines\\/", url: "/blog", code: 301 },
        { match: "^\\/guias$", url: "/blog", code: 301 },
        { match: "^\\/guias\\/seguridad$", url: "/blog", code: 301 },
        { match: "^\\/guias\\/joomla$", url: "/blog", code: 301 },
        { match: "^\\/feed\\/$", url: "/rss.xml", code: 301 },
