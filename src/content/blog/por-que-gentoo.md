...
- Un ciclo de actualizaciones _sobre la marcha_, que nos permite actualizarlos de forma lineal, cuando nosotros queremos
...
- Permite de forma sencilla crear tu propio repositorio y tener un sistema de compilación donde replicar los cambios al
  resto de servidores, antes también realizábamos _rpms_ personalizados, pero no es tan cómodo y práctico como un
  _ebuild_.
