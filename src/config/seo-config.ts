...
export const seoConfig = {
    home: {
      ...
      description: "Más de 10 años de experiencia ofreciendo soluciones basadas en Linux, servidores, hosting y desarrollo web con tecnologías libres.",
      image: logoInode,
    },
    about: {
      title: "Quiénes somos | INODE64",
      description: "Conoce al equipo de INODE64, nuestra filosofía de trabajo y nuestro compromiso con el software libre.",
      image: logoInode,
    },
    services: {
      title: "Servicios | INODE64",
      description: "Soluciones profesionales en administración de sistemas, correo electrónico, desarrollo web y más con tecnologías libres.",
      image: logoInode,
    },
    projects: {
      title: "Proyectos | INODE64",
      description: "Descubre nuestros proyectos realizados en el ámbito del software libre y la infraestructura tecnológica.",
      image: logoInode,
    },
    blog: {
      title: "Blog | INODE64",
